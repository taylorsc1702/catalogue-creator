...
function Preview({ items, layout, showOrderEditor, moveItemUp, moveItemDown, moveItemToPosition, itemLayouts, setItemLayout, clearItemLayout, itemBarcodeTypes, setItemBarcodeType, clearItemBarcodeType, hyperlinkToggle, generateProductUrl }: { 
          ...
          <div key={i} style={{ 
            ...
            <div style={{ 
              ...
              {it.authorBio && (
                <div style={{
                  ...
                  <div style={{ fontWeight: 600, marginBottom: 8, color: "#0D47A1" }}>Author Bio:</div>
                  <div dangerouslySetInnerHTML={{ __html: it.authorBio }} />
                </div>
              )}
              ...
              {it.additionalImages && it.additionalImages.length > 0 && (
                <div>
                  <div style={{ fontWeight: 600, marginBottom: 8, fontSize: 12, color: "#495057" }}>Internals:</div>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                {it.vendor && (
                  <div>
                    <strong>Vendor:</strong> {it.vendor}
                  </div>
                )}
                {it.dimensions && (
                  <div>
                    <strong>Dimensions:</strong> {it.dimensions}
                  </div>
                )}
                {it.releaseDate && (() => {
              ...
              <div style={{
                ...
                {it.icrkdt && (
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: 12, marginBottom: 4, color: "#6C757D" }}>Barcode:</div>
                    <div style={{ 
                      fontFamily: "monospace", 
                      fontSize: 16, 
                      fontWeight: 600,
                ...
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: 12, marginBottom: 4, color: "#6C757D" }}>Handle (ISBN):</div>
                  <div style={{ 
                    fontFamily: "monospace", 
                    fontSize: 16, 
                    fontWeight: 600,
  ...
  // Default grid layout for 2-up, 3-up, 4-up, 8-up
  return (
    <div style={{ 
      display: "grid", 
      gridTemplateColumns: "1fr 1fr", 
