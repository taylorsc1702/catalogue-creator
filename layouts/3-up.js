/**
 * 3-per-page layout handler for Google Apps Script
 */
...
// Create product card for 3-up layout (reuse from 2-up with different layout parameter)
function createProductCard(cell, item, layout) {
  ...
  try {
    ...
    // Product Details Table (for 3-per-page and larger layouts)
    if (layout >= 2) {
